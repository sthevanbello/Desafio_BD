...
SELECT J.Nome, J.Usuario, G.Descricao, P.Titulo, p.Texto, p.Imagem FROM TB_Jogadores AS J
	INNER JOIN	RL_Jogadores_Grupos AS RL ON J.Id = RL.JogadorId
	INNER JOIN TB_Grupos AS G ON G.Id = RL.GrupoId
...
SELECT J.Id, J.Nome, P.Titulo, P.Texto, CP.Categoria, G.Descricao AS 'Descrição Grupo', CG.Categoria AS 'Categoria Grupo' FROM TB_Postagens AS P 
